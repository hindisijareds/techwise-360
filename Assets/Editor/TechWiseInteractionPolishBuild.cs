...
public static class TechWiseInteractionPolishBuild
{
    public static void BuildQuest()
    {
        Directory.CreateDirectory("Builds/InteractionPolish"); Directory.CreateDirectory("Logs/InteractionPolish");
        ...
        try
        {
            ...
            var report = BuildPipeline.BuildPlayer(new BuildPlayerOptions {
                ...
                locationPathName = "Builds/InteractionPolish/TechWise360.apk", target = BuildTarget.Android, options = BuildOptions.Development });
            File.WriteAllText("Logs/InteractionPolish/build-summary.txt", $"{report.summary.result}\nErrors: {report.summary.totalErrors}\nWarnings: {report.summary.totalWarnings}\nDuration: {report.summary.totalTime}\n");

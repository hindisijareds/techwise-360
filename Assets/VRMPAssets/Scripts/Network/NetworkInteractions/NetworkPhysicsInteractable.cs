...
namespace XRMultiplayer
{
    ...
    public class NetworkPhysicsInteractable : NetworkBaseInteractable
    {
        ...
        public void ResetObjectPhysics()
        {
            ...
            if (CanSendNetworkMessages() && IsOwner && !NetworkManager.Singleton.ShutdownInProgress)
        ...
        {
            if (!CanSendNetworkMessages() || IsOwner || OwnershipTransferBlocked()) return;

...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            Hovered(true);
            if (syncHover && CanSendNetworkMessages())
            {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public virtual void OnSelectEnteredLocal(BaseInteractionEventArgs args)
        {
            ...
            {
                Selected(true);
                if (syncSelect && CanSendNetworkMessages())
                {
        ...
        public virtual void OnActivateLocal(BaseInteractionEventArgs args)
        {
            ...
            Activated(true);
            if (syncActivate && CanSendNetworkMessages())
            {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected bool CanSendNetworkMessages()
        {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        IEnumerator RelinquishOwnershipToHost()
        {
            ...
            if (!IsServer && !baseInteractable.isSelected && CanSendNetworkMessages())
            {
